        ...
        if (Board.instance == null) {
            ...
            for (let i = 0; i < Board.getInstance().getSize(); i++) {
                for (let j = 0; j < Board.getInstance().getSize(); j++) {
                    let t = new Tile();
                    t.setColor((i + j) % 2 == 0 ? "#ffffff" : "#fdd0ed");
                    t.initPosition([i, j]);
                    t.update();
                }
            }
            ...
            for (let m of legalMoves) {
                if (Board.samePosition(m, boardPos)) {
                    ...
                    if (this.gameState.getScore()[1]) {
                        ...
                        document.getElementById("loser").classList.add("loser-no-show");
                    }
                }
            }
        }
    ...
    gameLoop() {
        ...
        if (!this.playerTurn) {
            ...
            if (this.gameState.getScore()[1]) {
                ...
                document.getElementById("loser").classList.add("loser-show");
            }
        }
...
class GameAI {
    static moveKnight(king, knights, gameState) {
        ...
        function minimax(depth, maxPlayer, king, knight, cKnight) {
            ...
            if (maxPlayer) {
                ...
                for (const currentMove of legalMoves) {
                    ...
                    let currentEvaluation = minimax(depth - 1, false, king, knight, cKnight);
                ...
                for (const currentMove of legalMoves) {
                    ...
                    let currentEvaluation = minimax(depth - 1, true, king, knight, cKnight);
